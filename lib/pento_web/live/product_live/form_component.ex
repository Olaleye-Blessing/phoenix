defmodule PentoWeb.ProductLive.FormComponent do
  ...
  defp save_product(socket, :edit, params) do
    # result = Catalog.update_product(socket.assigns.product, product_params)
  ...
  defp save_product(socket, :new, params) do
    # result = Catalog.create_product(product_params)
  ...
  # process the image, maybe upload to cloud
